...
namespace DBModels.Migrations
{
    ...
    [Migration("20200202101300_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBModels.ModeratorsGroupDayStatistic", b =>
                {
                    ...
                    b.Property<int>("ResolvedEntitiesCount");

                    b.Property<TimeSpan>("SummedResolveTime");

                    b.Property<TimeSpan>("SummedTimeFromAssignationToResolving");

                    b.Property<TimeSpan>("SummedTimeToAssignation");

                    b.HasKey("Id");

                    b.HasIndex("OwnerId");

                    b.ToTable("ModeratorsGroupDayStatistic");
                });
            ...
            modelBuilder.Entity("DBModels.ViewStatistic<DBModels.Commentary>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ViewStatistic<Commentary>");
                });

            modelBuilder.Entity("DBModels.ViewStatistic<DBModels.Post>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ViewStatistic<Post>");
                });

            modelBuilder.Entity("DBModels.ViewStatistic<DBModels.Profile>", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ViewStatistic<Profile>");
                });
            ...
            modelBuilder.Entity("DBModels.BlogDayStatistic", b =>
                {
                    ...
                    b.HasOne("DBModels.ViewStatistic<DBModels.Commentary>", "CommentariesViewStatistic")
                        .WithMany()
                        .HasForeignKey("CommentariesViewStatisticId");

                    b.HasOne("DBModels.ViewStatistic<DBModels.Post>", "PostsViewStatistic")
                        .WithMany()
            ...
            modelBuilder.Entity("DBModels.Commentary", b =>
                {
                    ...
                    b.HasOne("DBModels.ViewStatistic<DBModels.Commentary>", "ViewStatistic")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DBModels.Post", b =>
                {
                    ...
                    b.HasOne("DBModels.ViewStatistic<DBModels.Post>", "ViewStatistic")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DBModels.ViewStatistic<DBModels.Commentary>", b =>
                {
                    b.HasOne("DBModels.Commentary", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId");
                });
            ...
            modelBuilder.Entity("DBModels.ViewStatistic<DBModels.Profile>", b =>
                {
                    b.HasOne("DBModels.Profile", "Owner")
                        .WithOne("ViewStatistic")
                        .HasForeignKey("DBModels.ViewStatistic<DBModels.Profile>", "OwnerId");
                });
