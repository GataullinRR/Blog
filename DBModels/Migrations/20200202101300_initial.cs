    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewStatistic<Profile>", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ViewStatistic<Profile>_ProfilesInfos_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "ProfilesInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewStatistic<Commentary>", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ViewStatistic<Commentary>_Commentaries_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Commentaries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewStatistic<Post>", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ViewStatistic<Post>_Posts_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogDayStatistic_ViewStatistic<Commentary>_CommentariesViewStatisticId",
                        column: x => x.CommentariesViewStatisticId,
                        principalTable: "ViewStatistic<Commentary>",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogDayStatistic_ViewStatistic<Post>_PostsViewStatisticId",
                        column: x => x.PostsViewStatisticId,
                        principalTable: "ViewStatistic<Post>",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewStatistic<Commentary>_OwnerId",
                table: "ViewStatistic<Commentary>",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ViewStatistic<Post>_OwnerId",
                table: "ViewStatistic<Post>",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ViewStatistic<Profile>_OwnerId",
                table: "ViewStatistic<Profile>",
                column: "OwnerId",
                unique: true,
                filter: "[OwnerId] IS NOT NULL");

            migrationBuilder.AddForeignKey(
                name: "FK_Commentaries_ViewStatistic<Commentary>_Id",
                table: "Commentaries",
                column: "Id",
                principalTable: "ViewStatistic<Commentary>",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Posts_ViewStatistic<Post>_Id",
                table: "Posts",
                column: "Id",
                principalTable: "ViewStatistic<Post>",
                principalColumn: "Id",
